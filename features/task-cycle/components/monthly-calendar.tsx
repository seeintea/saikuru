...
const CalendarDay = ({ data, onPress }: { data: CalendarDayData; onPress?: (date: Date) => void }) => {
  const statusColor = data.status ? STATUS_COLORS[data.status as keyof typeof STATUS_COLORS] : "transparent";
    ...
    <View style={styles.container}>
      ...
      <View style={styles.calendarCard}>
        ...
        <View style={styles.header}>
          <TouchableOpacity onPress={handlePreviousMonth} style={styles.navButton} activeOpacity={0.7}>
